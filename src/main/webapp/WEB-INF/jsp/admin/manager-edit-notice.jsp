...
<div class="container">
  <form action="${pageContext.request.contextPath}/admin/notice/operate" method="POST">
  <input type="hidden" value="${notice.id }" name="id">
  <div class="form-group">
    <label for="account">公告标题</label>
	<input type="text" class="form-control" id="title"  name="title" placeholder="请输入管理员账户" value="${notice.title }">
  </div>
  <div class="form-group">
    <label for="password">公告内容</label>
    <textarea rows="4" cols="5" class="form-control" name="content">${notice.content }</textarea>
