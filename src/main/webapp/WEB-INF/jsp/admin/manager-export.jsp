    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="nav-bar">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="${pageContext.request.contextPath }/admin/getStudentPaperInfo">查询导出</a></li>
            </ul>
...
<div class="container">
    <section>
        <h4>论文情况跟踪：</h4>
        <form action="${pageContext.request.contextPath }/admin/getStudentPaperInfo" method="POST">
            ...
            <c:forEach items="${papers}" var="item">
                <tr>
                    ...
                    <td>
                        ...
                        <c:if test="${item.paperStatus==3}"> 基本合格 </c:if>
                    </td>
                </tr>
            </c:forEach>
        </table>
