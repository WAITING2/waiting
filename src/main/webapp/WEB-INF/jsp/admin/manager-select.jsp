  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="nav-bar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="${pageContext.request.contextPath }/admin/selection">查看选题情况</a></li>
...
<div class="container">
  <div class="row">
      <div class="col-md-6 col-xs-6">
        <h4 style="padding-left:8px;">选题情况</h4>
      </div>
    </div>
  <table class="table">
    <tr><th>学生姓名</th><th>指导老师</th><th>题目</th><th>当前完成情况</th><th>操作</th></tr>
    <c:forEach items="${requestScope.selections }" var="item">
     	<tr><td>${item.student.studentName }</td><td>${item.teacher.teacherName }</td><td>${item.topic.topic }</td><td>${item.processing }</td><td><a href="${pageContext.request.contextPath }/admin/selection/remove?student=${item.student.studentNumber}" class="btn btn-danger btn-sm">注销选题</a></td></tr>
    </c:forEach>
  </table>
  </div>
</body>
