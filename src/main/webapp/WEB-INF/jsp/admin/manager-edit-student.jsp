...
<div class="container">
  <form action="" id="operatForm" method="POST">
  ...
  <div class="form-group">
    ...
    <c:choose>
    	...
    	<c:otherwise>
			<input type="text" class="form-control"id="studentNumber" name="studentNumber" placeholder="请输入学号" value="${requestScope.student.studentNumber }" >
   		 </c:otherwise>
    </c:choose>
  </div>
  <div class="form-group">
