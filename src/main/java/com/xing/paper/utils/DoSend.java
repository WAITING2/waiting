...
public class DoSend {
	...
	private static String from = "pamking@yeah.net"; // 发件人邮箱地址
	private static String user = "pamking@yeah.net"; // 发件人称号，同邮箱地址
	private static String password = "pamking123"; // 发件人邮箱客户端授权码
...
//		ds.sendMail("1590184@qq.com", "你好，这是一封测试邮件，无需回复。", "测试邮件");
