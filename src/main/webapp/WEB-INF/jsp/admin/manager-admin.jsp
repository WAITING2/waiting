  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="nav-bar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="${pageContext.request.contextPath }/admin/administrator">管理系统管理员用户</a></li>
...
<div class="container">
  <div class="row">
      <div class="col-md-6 col-xs-6">
        <h4 style="padding-left:8px;">管理员管理</h4>
      </div>
      <div class="col-md-6 col-xs-6">
        <a href="${pageContext.request.contextPath }/admin/administrator/add.html" class="btn btn-primary btn" style="float:right;">添加管理员账户</a>
      </div>
    </div>
  <table class="table">
    <tr><th class="col-md-6 col-xs-6">账户</th><th class="col-md-6 col-xs-6">操作</th></tr>
    <c:forEach items="${requestScope.admins }" var="item" >
    	<tr><td>${item.userName }</td><td><a  href="${pageContext.request.contextPath }/admin/administrator/${item.id}.html"class="btn btn-warning">修改</a> <a href ="${pageContext.request.contextPath }/admin/administrator/remove?id=${item.id}" class="btn btn-danger">删除</a></td></tr>
    </c:forEach>
