...
<div class="container">
  <form action="${requestScope.formAction }" method="POST" onsubmit="return  register_1234()">
  <div class="form-group">
    ...
    <c:choose>
    	...
    	<c:otherwise>
			<input type="text" class="form-control" maxlength="10"  onfocus="warnT_Number()" onblur="return checkT_Number()" id="teacherNumber" name="teacherNumber" id="teacherNumber" placeholder="请输入工号" value="">   		 </c:otherwise>
    	</c:choose>
  </div>
      <div id="t_numberts"
